...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen bg-white" data-testid="home-page">
      ...
      <section className="relative h-[70vh] overflow-hidden pt-14 lg:" data-testid="hero-section">
        {/* Video Background */}
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 sm:gap-4">
              {premium.slice(0, 10).map((enterprise) => (
                <Link 
                  key={enterprise.id} 
                  to={`/entreprise/${enterprise.id}`}
                  className="group bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition-all border border-amber-200"
                >
                  <div className="aspect-[4/3] relative overflow-hidden">
                    <img 
                      src={enterprise.cover_image || enterprise.logo || '/placeholder.jpg'} 
