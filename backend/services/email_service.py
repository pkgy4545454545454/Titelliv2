...
TITELLI_LOGO = "https://video-platform-730.preview.emergentagent.com/logo192.png"
                        ...
                        <tr>
                            <td style="padding: 30px;">
                                ...
                                <table width="100%" cellpadding="0" cellspacing="0" style="margin: 25px 0;">
                                    <tr>
                                        <td align="center">
                                            <a href="https://video-platform-730.preview.emergentagent.com/dashboard/client?tab=parrainage" 
                        ...
                        <tr>
                            <td style="background-color: #18181b; padding: 20px; text-align: center; border-top: 1px solid #3f3f46;">
                                <p style="color: #71717a; font-size: 12px; margin: 0;">
                                    ...
                                    <a href="https://video-platform-730.preview.emergentagent.com" style="color: #a855f7; text-decoration: none;">titelli.ch</a>
                                </p>
                            </td>
                        </tr>
                    </table>
                    ...
                    <table width="600" cellpadding="0" cellspacing="0" style="background-color: #27272a; border-radius: 16px; overflow: hidden;">
                        ...
                        <tr>
                            <td style="padding: 30px;">
                                ...
                                <table width="100%" cellpadding="0" cellspacing="0" style="margin: 25px 0;">
                                    <tr>
                                        <td align="center">
                                            <a href="https://video-platform-730.preview.emergentagent.com/dashboard/client" 
                        ...
                        <tr>
                            <td style="background-color: #18181b; padding: 20px; text-align: center; border-top: 1px solid #3f3f46;">
                                <p style="color: #71717a; font-size: 12px; margin: 0;">
                                    © 2026 Titelli - Social Commerce Suisse<br>
                                    <a href="https://video-platform-730.preview.emergentagent.com" style="color: #d4af37; text-decoration: none;">titelli.ch</a>
                                </p>
                            </td>
                        </tr>
                    </table>
                    ...
                    <table width="600" cellpadding="0" cellspacing="0" style="background-color: #27272a; border-radius: 16px; overflow: hidden;">
                        ...
                        <tr>
                            <td style="background-color: #18181b; padding: 20px; text-align: center; border-top: 1px solid #3f3f46;">
                                <p style="color: #71717a; font-size: 12px; margin: 0;">
                                    © 2026 Titelli - Social Commerce Suisse<br>
                                    <a href="https://video-platform-730.preview.emergentagent.com" style="color: #fbbf24; text-decoration: none;">titelli.ch</a>
                                </p>
                            </td>
                        </tr>
                    </table>
                    ...
                    <table width="600" cellpadding="0" cellspacing="0" style="background-color: #27272a; border-radius: 16px; overflow: hidden;">
                        ...
                        <tr>
                            <td style="background-color: #18181b; padding: 20px; text-align: center; border-top: 1px solid #3f3f46;">
                                <p style="color: #71717a; font-size: 12px; margin: 0;">
                                    © 2026 Titelli - Social Commerce Suisse<br>
                                    <a href="https://video-platform-730.preview.emergentagent.com" style="color: #10b981; text-decoration: none;">titelli.ch</a>
                                </p>
                            </td>
                        </tr>
                    </table>
                        ...
                        <tr>
                            <td style="padding: 30px;">
                                ...
                                <table width="100%" cellpadding="0" cellspacing="0" style="margin: 25px 0;">
                                    <tr>
                                        <td align="center">
                                            <a href="https://video-platform-730.preview.emergentagent.com/dashboard/entreprise?tab=commandes-titelli" 
                        ...
                        <tr>
                            <td style="background-color: #18181b; padding: 20px; text-align: center; border-top: 1px solid #3f3f46;">
                                <p style="color: #71717a; font-size: 12px; margin: 0;">
                                    ...
                                    <a href="https://video-platform-730.preview.emergentagent.com/media-pub" style="color: #f59e0b; text-decoration: none;">Créer une autre publicité</a>
                                </p>
                            </td>
                        </tr>
                    </table>
