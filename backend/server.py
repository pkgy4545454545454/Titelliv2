...
ENTERPRISE_SUBCATEGORIES = {
    ...
    'Cafe': ['Expresso', 'Brunch', 'Pâtisseries', 'Wifi', 'Coworking'],
    'Café': ['Expresso', 'Brunch', 'Pâtisseries', 'Wifi', 'Coworking'],
    'Tea Room': ['Thé', 'Pâtisseries', 'Brunch', 'Salon de thé'],
    'Fast Food': ['Burger', 'Pizza', 'Kebab', 'Sandwich', 'Poulet frit', 'Tacos'],
    'Pizzeria': ['Pizza traditionnelle', 'Pizza napolitaine', 'Pizza romaine', 'Calzone', 'Livraison'],
    'Sushi': ['Sushi', 'Sashimi', 'Maki', 'Poke bowl', 'Ramen'],
    'Kebab': ['Döner', 'Assiette', 'Falafel', 'Lahmacun'],
    'Traiteur': ['Événements', 'Mariage', 'Entreprise', 'Plateaux repas', 'Buffet'],
    'Chinois': ['Cantonais', 'Sichuan', 'Dim sum', 'Wok', 'Nouilles'],
    'Italien': ['Pasta', 'Pizza', 'Risotto', 'Antipasti', 'Dolce'],
    'Japonais': ['Sushi', 'Ramen', 'Teppanyaki', 'Izakaya', 'Bento'],
    'Thai': ['Curry', 'Pad Thai', 'Tom Yum', 'Street food'],
    'Indien': ['Curry', 'Tandoori', 'Naan', 'Biryani', 'Végétarien'],
    'Grec': ['Gyros', 'Souvlaki', 'Moussaka', 'Mezze'],
    'Mexicain': ['Tacos', 'Burrito', 'Quesadilla', 'Guacamole', 'Nachos'],
    'Vietnamien': ['Pho', 'Banh mi', 'Rouleaux printemps', 'Bo bun'],
    'Turc': ['Döner', 'Lahmacun', 'Pide', 'Mezze'],
    'Bresilien': ['Churrasco', 'Feijoada', 'Açai', 'Picanha'],
    'Poke Bowl': ['Saumon', 'Thon', 'Végétarien', 'Poulet'],
    'Salade': ['Composée', 'César', 'Healthy', 'Bowl'],
    'Sandwich': ['Club', 'Panini', 'Wrap', 'Bagel'],
    
    # ALIMENTATION
    'Alimentation': ['Épicerie fine', 'Bio', 'Produits locaux', 'International', 'Vrac'],
    ...
    'Pâtisserie': ['Gâteaux', 'Tartes', 'Macarons', 'Entremets', 'Wedding cakes'],
    'Chocolaterie': ['Pralines', 'Truffes', 'Tablettes', 'Cadeaux', 'Artisanal'],
    'Confiserie': ['Bonbons', 'Caramels', 'Nougat', 'Sucettes', 'Artisanal'],
    'Boucherie': ['Boeuf', 'Volaille', 'Agneau', 'Charcuterie', 'Bio', 'Halal'],
    'Fromagerie': ['Fromages suisses', 'Fromages français', 'Affinés', 'Fondue', 'Raclette'],
    'Epicerie': ['Produits frais', 'Conserves', 'International', 'Bio', 'Vrac'],
    'Épicerie': ['Produits frais', 'Conserves', 'International', 'Bio', 'Vrac'],
    'Épicerie Fine': ['Produits d\'exception', 'Caviar', 'Truffes', 'Huiles', 'Cadeaux'],
    'Primeur': ['Fruits', 'Légumes', 'Bio', 'Saison', 'Local'],
    'Supermarche': ['Alimentaire', 'Hygiène', 'Ménager', 'Drive', 'Livraison'],
    'Supermarché': ['Alimentaire', 'Hygiène', 'Ménager', 'Drive', 'Livraison'],
    'Bio & Santé': ['Alimentation bio', 'Compléments', 'Cosmétiques', 'Vrac'],
    'Caviste': ['Vins français', 'Vins suisses', 'Spiritueux', 'Champagne', 'Conseil'],
    'Cave à Vin': ['Vins rouges', 'Vins blancs', 'Rosés', 'Millésimes', 'Dégustation'],
    'Spiritueux': ['Whisky', 'Cognac', 'Rhum', 'Vodka', 'Gin'],
    'Boissons': ['Sodas', 'Jus', 'Eaux', 'Énergisantes', 'Sans alcool'],
    'Glacier': ['Glaces artisanales', 'Sorbets', 'Granités', 'Sundae'],
    ...
    'Beauté & Bien-être': ['Soins', 'Massage', 'Spa', 'Cosmétiques', 'Relaxation'],
    'Beauté & Santé': ['Soins', 'Cosmétiques', 'Bien-être', 'Santé naturelle'],
    'Spa': ['Massage', 'Sauna', 'Hammam', 'Jacuzzi', 'Soins du corps', 'Balnéothérapie'],
    'spa': ['Massage', 'Sauna', 'Hammam', 'Jacuzzi', 'Relaxation'],
    'Massage': ['Relaxant', 'Sportif', 'Thérapeutique', 'Pierres chaudes', 'Ayurvédique'],
    'Massage & Spa': ['Relaxant', 'Sportif', 'Duo', 'Sauna', 'Hammam'],
    'Massage Thai': ['Traditionnel', 'Aux huiles', 'Pieds', 'Dos'],
    'Massage Shiatsu': ['Traditionnel', 'Relaxation', 'Énergie'],
    'Manucure': ['Pose vernis', 'Semi-permanent', 'Gel', 'Nail art', 'French'],
    'Onglerie': ['Pose complète', 'Remplissage', 'Nail art', 'Gel', 'Résine'],
    'Epilation': ['Cire', 'Laser', 'Lumière pulsée', 'Électrolyse'],
    'Epilation Laser': ['Corps', 'Visage', 'Bikini', 'Aisselles'],
    'Bronzage': ['UV', 'Spray tan', 'Autobronzant'],
    'Solarium': ['UV', 'Collagène', 'Cabine'],
    'Maquillage': ['Jour', 'Soirée', 'Mariée', 'Cours', 'Conseil'],
    'Parfumerie': ['Parfums femme', 'Parfums homme', 'Cosmétiques', 'Soins', 'Coffrets'],
    'Cosmétiques': ['Soins visage', 'Soins corps', 'Maquillage', 'Bio', 'Luxe'],
    'Extensions Cheveux': ['Pose', 'Entretien', 'Naturel', 'Synthétique'],
    'Coloriste': ['Balayage', 'Ombré', 'Couleur', 'Mèches', 'Correction'],
    'Visagiste': ['Relooking', 'Conseil image', 'Morphologie', 'Style'],
    'Tatouage & Piercing': ['Tatouage artistique', 'Cover up', 'Piercing', 'Détatouage'],
    'Tatoueur': ['Réaliste', 'Old school', 'Géométrique', 'Japonais', 'Minimaliste'],
    'Body Art': ['Tatouage', 'Piercing', 'Henné', 'Body painting'],
    ...
    'Pharmacie & Droguerie': ['Médicaments', 'Parapharmacie', 'Hygiène', 'Beauté'],
    'Opticien': ['Lunettes de vue', 'Lunettes de soleil', 'Lentilles', 'Examen', 'Réparation'],
    'Optique': ['Lunettes', 'Lentilles', 'Solaires', 'Sport'],
    'Lentilles': ['Journalières', 'Mensuelles', 'Couleur', 'Progressives'],
    'Appareils Auditifs': ['Aides auditives', 'Accessoires', 'Réglage', 'Entretien'],
    'Audioprothesiste': ['Bilan auditif', 'Appareillage', 'Suivi', 'Accessoires'],
    'Kine': ['Rééducation', 'Sport', 'Post-opératoire', 'Massage', 'Drainage'],
    'Kinesitherapie': ['Musculaire', 'Articulaire', 'Respiratoire', 'Sportive'],
    'Physiotherapie': ['Rééducation', 'Mobilité', 'Douleur', 'Post-trauma'],
    'Osteopathe': ['Dos', 'Articulations', 'Viscéral', 'Crânien', 'Sportif'],
    'Psychologue': ['Thérapie individuelle', 'Couple', 'Enfant', 'TCC', 'Psychanalyse'],
    'Psychotherapeute': ['Thérapie', 'Coaching', 'Hypnose', 'EMDR'],
    'Psychiatre': ['Consultation', 'Suivi', 'Thérapie', 'Médicaments'],
    'Nutritionniste': ['Régime', 'Bilan nutritionnel', 'Sport', 'Pathologie', 'Végétarien'],
    'Dermatologue': ['Acné', 'Eczéma', 'Psoriasis', 'Dépistage', 'Esthétique'],
    'Cardiologue': ['Bilan cardiaque', 'ECG', 'Holter', 'Suivi', 'Prévention'],
    'Ophtalmologue': ['Examen', 'Chirurgie', 'Glaucome', 'Cataracte', 'Laser'],
    'Gynecologue': ['Suivi', 'Grossesse', 'Contraception', 'Dépistage'],
    'Pediatre': ['Consultation', 'Vaccination', 'Suivi croissance', 'Urgence'],
    'Orthodontiste': ['Bagues', 'Gouttières', 'Invisalign', 'Contention'],
    'Orthopediste': ['Semelles', 'Attelles', 'Prothèses', 'Orthèses'],
    'Naturopathe': ['Phytothérapie', 'Nutrition', 'Aromathérapie', 'Bilan'],
    'Acupuncture': ['Douleur', 'Stress', 'Fertilité', 'Addiction', 'Minceur'],
    'Hypnotherapie': ['Arrêt tabac', 'Phobie', 'Confiance', 'Poids', 'Sommeil'],
    'Chirurgien': ['Générale', 'Plastique', 'Orthopédique', 'Digestive'],
    'Chirurgie': ['Générale', 'Plastique', 'Orthopédique', 'Esthétique'],
    'Chirurgie Plastique': ['Visage', 'Corps', 'Poitrine', 'Liposuccion', 'Reconstruction'],
    'Clinique': ['Consultation', 'Chirurgie', 'Maternité', 'Urgences'],
    'Hopital': ['Urgences', 'Consultation', 'Hospitalisation', 'Chirurgie'],
    'Laboratoire': ['Analyses sang', 'Urine', 'Biopsie', 'COVID'],
    'Analyses': ['Sang', 'Urine', 'Biochimie', 'Microbiologie'],
    'Sage Femme': ['Suivi grossesse', 'Préparation', 'Post-partum', 'Rééducation'],
    'Infirmier': ['Soins', 'Pansements', 'Injections', 'Domicile'],
    'Ambulance': ['Urgence', 'Transport sanitaire', 'Rapatriement'],
    'Veterinaire': ['Chiens', 'Chats', 'NAC', 'Équins', 'Urgences', 'Chirurgie', 'Vaccination'],
    'Acide Hyaluronique': ['Lèvres', 'Visage', 'Rides', 'Hydratation'],
    
    # MODE & ACCESSOIRES
    'Mode': ['Femme', 'Homme', 'Enfant', 'Luxe', 'Streetwear', 'Vintage'],
    'Mode & Accessoires': ['Vêtements femme', 'Vêtements homme', 'Chaussures', 'Sacs', 'Bijoux'],
    'Mode & Vêtements': ['Femme', 'Homme', 'Enfant', 'Grandes tailles', 'Sport'],
    'Mode femme': ['Robes', 'Pantalons', 'Tops', 'Accessoires', 'Lingerie'],
    'Vetements': ['Casual', 'Soirée', 'Sport', 'Business', 'Outdoor'],
    'vetements_mode': ['Femme', 'Homme', 'Enfant', 'Sport', 'Accessoires'],
    'Chaussures': ['Femme', 'Homme', 'Enfant', 'Sport', 'Luxe', 'Réparation'],
    'Lingerie': ['Soutien-gorge', 'Culotte', 'Pyjama', 'Maillot de bain', 'Shapewear'],
    'Maroquinerie': ['Sacs', 'Portefeuilles', 'Ceintures', 'Bagages', 'Réparation'],
    'Bagages': ['Valises', 'Sacs de voyage', 'Cabine', 'Accessoires'],
    'Sacs': ['À main', 'Bandoulière', 'Dos', 'Luxe', 'Marque'],
    'Accessoires': ['Foulards', 'Chapeaux', 'Gants', 'Ceintures', 'Lunettes'],
    'Accessoires luxe': ['Montres', 'Bijoux', 'Sacs', 'Ceintures', 'Lunettes'],
    ...
    'bijouteries': ['Bagues', 'Colliers', 'Bracelets', "Boucles d'oreilles", 'Montres', 'Sur mesure', 'Réparation'],
    'Bijouteries & Horlogerie': ['Montres de luxe', 'Bijoux', 'Réparation montres', 'Gravure', 'Estimation', 'Rachat'],
    'Bijouterie fantaisie': ['Fantaisie', 'Tendance', 'Acier', 'Plaqué or'],
    'Horlogerie': ['Montres de luxe', 'Montres sport', 'Montres connectées', 'Réparation', 'Estimation', 'Rachat'],
    'Gravure': ['Bijoux', 'Trophées', 'Plaques', 'Personnalisation'],
    
    # AUTOMOBILE & TRANSPORT
    'Garage': ['Réparation', 'Entretien', 'Carrosserie', 'Pneus', 'Vidange', 'Diagnostic', 'Climatisation auto'],
    'Automobile': ['Vente', 'Achat', 'Location', 'Entretien', 'Pièces'],
    'Automobile & Garage': ['Réparation', 'Entretien', 'Carrosserie', 'Pneus', 'Vidange', 'Diagnostic', 'Vente véhicules'],
    'Automobile & Garages': ['Réparation', 'Entretien', 'Carrosserie', 'Vente'],
    'Auto': ['Vente', 'Occasion', 'Réparation', 'Location'],
    'Auto Ecole': ['Permis B', 'Permis moto', 'Permis camion', 'Code', 'Perfectionnement'],
    'Concessionnaire': ['Neuf', 'Occasion', 'Reprise', 'Leasing', 'Financement'],
    'Depannage Auto': ['Remorquage', 'Crevaison', 'Batterie', 'Clés'],
    'Pneu': ['Été', 'Hiver', 'Toutes saisons', 'Changement', 'Équilibrage'],
    'Pneumatique': ['Pneus', 'Jantes', 'Équilibrage', 'Géométrie'],
    'Carreleur': ['Pose', 'Rénovation', 'Mosaïque', 'Terrasse'],
    'Lavage Auto': ['Lavage extérieur', 'Intérieur', 'Pressing', 'Polissage'],
    'Peinture Auto': ['Carrosserie', 'Retouches', 'Covering', 'Protection'],
    'Debosselage': ['Sans peinture', 'Grêle', 'Chocs'],
    'Controle Technique': ['Visite', 'Contre-visite', 'Antipollution'],
    'Location Voiture': ['Courte durée', 'Longue durée', 'Utilitaire', 'Luxe'],
    'Rent A Car': ['Voiture', 'Utilitaire', 'Minibus', 'Prestige'],
    'Taxi': ['Aéroport', 'Gare', 'Longue distance', 'Médical'],
    'Vtc': ['Premium', 'Affaires', 'Événement', 'Aéroport'],
    'Chauffeur Prive': ['Transfert', 'Événement', 'Tourisme', 'Affaires'],
    'Demenagement': ['Local', 'National', 'International', 'Garde-meubles', 'Emballage'],
    'Assistance Routiere': ['Dépannage', 'Remorquage', 'Crevaison', '24/7'],
    'Motocycle': ['Vente', 'Réparation', 'Accessoires', 'Équipement'],
    'Deux Roues': ['Moto', 'Scooter', 'Vélo', 'Trottinette'],
    'Velo Electrique': ['Urbain', 'VTT', 'Cargo', 'Pliable', 'Location'],
    'Vélos & Cycles': ['Vente', 'Réparation', 'Location', 'Accessoires'],
    ...
    'Courtier Immobilier': ['Financement', 'Négociation', 'Recherche', 'Conseil'],
    'Architecte': ['Maison individuelle', 'Appartement', 'Commercial', 'Rénovation', 'Extension', 'Décoration intérieure'],
    'Architecte Paysagiste': ['Jardin', 'Terrasse', 'Piscine', 'Espaces verts'],
    'Architecture d\'intérieur': ['Design', 'Aménagement', 'Décoration', 'Plans'],
    'Décoration': ['Intérieur', 'Conseil', 'Home staging', 'Aménagement'],
    'Décoration d\'intérieur': ['Conseil', 'Projet', 'Achat', 'Aménagement'],
    ...
    'Serrurerie': ['Dépannage', 'Clés', 'Serrures', 'Blindage', 'Coffres'],
    'Peinture': ['Intérieur', 'Extérieur', 'Décoration', 'Ravalement', 'Enduit'],
    'Maconnerie': ['Gros œuvre', 'Rénovation', 'Extension', 'Façade', 'Clôture'],
    'Menuiserie': ['Fenêtres', 'Portes', 'Escaliers', 'Placards', 'Sur mesure'],
    'Charpente': ['Construction', 'Rénovation', 'Traitement', 'Isolation'],
    'Toiture': ['Réparation', 'Rénovation', 'Isolation', 'Nettoyage', 'Gouttières'],
    'Facade': ['Ravalement', 'Isolation', 'Peinture', 'Crépi'],
    'Parquet': ['Pose', 'Rénovation', 'Vitrification', 'Ponçage'],
    'Carrelage': ['Pose', 'Faïence', 'Mosaïque', 'Terrasse'],
    'Chauffage': ['Installation', 'Entretien', 'Dépannage', 'Pompe à chaleur', 'Plancher chauffant'],
    'Climatisation': ['Installation', 'Entretien', 'Dépannage', 'Réversible'],
    'Ventilation': ['VMC', 'Extraction', 'Purification', 'Maintenance'],
    'Pompe Chaleur': ['Air-air', 'Air-eau', 'Géothermie', 'Installation'],
    'Chaudiere': ['Gaz', 'Fioul', 'Entretien', 'Remplacement'],
    'Ramonage': ['Cheminée', 'Chaudière', 'Poêle', 'Certificat'],
    'Nettoyage': ['Bureaux', 'Vitres', 'Fin de chantier', 'Appartement', 'Régulier'],
    'Pressing': ['Vêtements', 'Cuir', 'Mariage', 'Couettes', 'Tapis'],
    'Pressing & Laverie': ['Pressing', 'Laverie', 'Repassage', 'Retouches'],
    'Teinturerie': ['Pressing', 'Cuir', 'Daim', 'Rideaux'],
    'Couture & Mercerie': ['Retouches', 'Création', 'Tissus', 'Mercerie'],
    'Paysagiste': ['Création jardin', 'Entretien', 'Élagage', 'Clôture'],
    ...
    'Domotique': ['Éclairage', 'Chauffage', 'Volets', 'Sécurité', 'Multimédia'],
    
    # SERVICES PROFESSIONNELS
    'Avocat': ['Droit pénal', 'Droit civil', 'Droit des affaires', 'Droit de la famille', 'Droit du travail', 'Droit immobilier', 'Droit fiscal'],
    'Avocats': ['Pénal', 'Civil', 'Affaires', 'Famille', 'Travail'],
    'Notaire': ['Immobilier', 'Succession', 'Mariage', 'Donation', 'Testament'],
    'Notaires': ['Immobilier', 'Succession', 'Famille', 'Entreprise'],
    'Etude Notariale': ['Actes', 'Succession', 'Immobilier', 'Conseil'],
    'Comptable': ['Comptabilité générale', 'Fiscalité', 'Paie', 'Création entreprise', 'Audit', 'Conseil'],
    'Expert Comptable': ['Comptabilité', 'Fiscalité', 'Audit', 'Conseil', 'Social'],
    'Fiduciaire': ['Comptabilité', 'Fiscalité', 'Audit', 'Conseil', 'Administration'],
    'Fiduciaires': ['Comptabilité', 'Fiscalité', 'Conseil', 'Gestion'],
    'Conseiller Fiscal': ['Optimisation', 'Déclaration', 'Planification', 'International'],
    'Conseil Patrimonial': ['Investissement', 'Succession', 'Retraite', 'Assurance'],
    'Banque': ['Compte courant', 'Épargne', 'Crédit immobilier', 'Crédit auto', 'Assurance', 'Investissement', 'Banque privée'],
    'Etablissement Bancaire': ['Comptes', 'Crédits', 'Épargne', 'Investissement'],
    'Assurance': ['Auto', 'Habitation', 'Santé', 'Vie', 'Professionnelle', 'Voyage'],
    'Assurances': ['Auto', 'Habitation', 'Santé', 'Vie', 'Entreprise'],
    'Assurance Entreprise': ['RC Pro', 'Multirisque', 'Homme clé', 'Flotte'],
    'Assurance Habitation': ['Propriétaire', 'Locataire', 'Colocation', 'Résidence secondaire'],
    'Assurance Maladie': ['Complémentaire', 'LAMal', 'Frontalier', 'Famille'],
    'Courtier Assurance': ['Comparatif', 'Négociation', 'Sinistre', 'Conseil'],
    'Agent Assurance': ['Souscription', 'Sinistres', 'Conseil', 'Prévention'],
    'Hypotheque': ['Achat', 'Renégociation', 'Rachat', 'Simulation'],
    'Consultant': ['Stratégie', 'Organisation', 'Digital', 'RH'],
    'Consultants': ['Management', 'IT', 'Finance', 'Stratégie'],
    'Coach': ['Vie', 'Professionnel', 'Sport', 'Leadership'],
    'Coach & Thérapeute': ['Développement personnel', 'Burnout', 'Transition', 'Confiance'],
    'Coach Professionnel': ['Carrière', 'Management', 'Performance', 'Leadership'],
    'Life Coach': ['Objectifs', 'Équilibre', 'Relations', 'Changement'],
    'Executive Coach': ['Leadership', 'Prise de poste', 'Performance', 'Vision'],
    ...
    'Depannage Informatique': ['Virus', 'Réparation', 'Installation', 'Récupération données'],
    'Reparation Ordinateur': ['PC', 'Mac', 'Écran', 'Clavier', 'Disque dur'],
    'Cloud': ['Hébergement', 'Sauvegarde', 'Sécurité', 'Migration'],
    'Webdesigner': ['Site vitrine', 'E-commerce', 'Responsive', 'UX/UI'],
    'Application': ['Mobile', 'Web', 'Métier', 'Maintenance'],
    'Numerique': ['Digital', 'Transformation', 'Marketing', 'E-commerce'],
    'Smartphone': ['Réparation', 'Accessoires', 'Vente', 'Rachat'],
    'Telephone': ['Fixe', 'Mobile', 'Accessoires', 'Forfait'],
    'Téléphonie': ['Mobile', 'Fixe', 'Internet', 'Forfait'],
    'Ordinateur': ['Vente', 'Réparation', 'Accessoires', 'Occasion'],
    'Pc': ['Assemblage', 'Gaming', 'Bureau', 'Portable'],
    'Tablette': ['Vente', 'Réparation', 'Accessoires', 'Occasion'],
    'Television': ['Vente', 'Installation', 'Réparation', 'Smart TV'],
    'Electronique': ['Grand public', 'Composants', 'Réparation', 'Accessoires'],
    'Électronique': ['Audio', 'Vidéo', 'Composants', 'Domotique'],
    'Hifi': ['Enceintes', 'Ampli', 'Vinyle', 'Streaming'],
    ...
    'Pilates': ['Mat', 'Reformer', 'Prénatal', 'Postnatal'],
    'Zumba': ['Fitness', 'Toning', 'Kids', 'Gold'],
    'Arts Martiaux': ['Karaté', 'Judo', 'Taekwondo', 'MMA', 'Boxe', 'Krav Maga'],
    'Tennis': ['Cours', 'Location court', 'Compétition', 'Stage'],
    'Golf': ['Cours', 'Parcours', 'Driving range', 'Pro shop'],
    'Driving Range': ['Entraînement', 'Leçons', 'Fitting'],
    'Natation': ['Cours', 'Aquagym', 'Aquabike', 'Bébé nageur'],
    'Piscine': ['Cours', 'Libre', 'Aquagym', 'Bien-être'],
    'Plongee': ['Baptême', 'Formation', 'Sortie', 'Équipement'],
    'Ski': ['Cours', 'Location', 'Forfait', 'Freeride'],
    'Escalade': ['Salle', 'Outdoor', 'Cours', 'Stage'],
    'Equitation': ['Cours', 'Balade', 'Pension', 'Compétition'],
    'Skateboard': ['Skatepark', 'Cours', 'Équipement'],
    'Voile': ['Cours', 'Location', 'Croisière', 'Régate'],
    'Nautisme': ['Bateau', 'Jet ski', 'Permis', 'Location'],
    'Sport': ['Équipements', 'Vêtements', 'Accessoires', 'Nutrition'],
    'Sports & Loisirs': ['Équipements', 'Vêtements', 'Outdoor', 'Fitness'],
    'Articles Sport': ['Chaussures', 'Vêtements', 'Équipement', 'Accessoires'],
    'Outdoor & Randonnée': ['Équipement', 'Vêtements', 'Camping', 'Trekking'],
    'Randonnee': ['Équipement', 'Guide', 'Organisation', 'Formation'],
    
    # HÔTELLERIE & TOURISME
    'Hotel': ['Hôtel de luxe', 'Hôtel business', 'Hôtel familial', 'Boutique hôtel', 'Apart-hôtel', 'Auberge'],
    'Hôtellerie': ['Luxe', 'Business', 'Économique', 'Charme'],
    'Auberge': ['Jeunesse', 'Montagne', 'Campagne', 'Chambre'],
    'Apart Hotel': ['Studio', 'Appartement', 'Long séjour', 'Famille'],
    'Camping': ['Emplacement', 'Mobil-home', 'Chalet', 'Piscine'],
    'Hebergement': ['Hôtel', 'Gîte', 'Chambre d\'hôte', 'Appartement'],
    'Agence Voyage': ['Circuits', 'Séjours', 'Vols', 'Croisières'],
    'Agence de Voyage': ['Forfait', 'Sur mesure', 'Groupe', 'Affaires'],
    'Tourisme': ['Excursions', 'Visites', 'Activités', 'Transfert'],
    'Excursion': ['Journée', 'Demi-journée', 'Groupe', 'Privé'],
    'Croisiere': ['Fluviale', 'Maritime', 'Lac', 'Fjord'],
    
    # ÉDUCATION & FORMATION
    'Formation': ['Formation continue', 'Certification', 'Langues', 'Informatique', 'Management', 'Comptabilité', 'Marketing'],
    'Enseignement - Ecoles': ['Primaire', 'Secondaire', 'Supérieur', 'Privé'],
    'Cours Professionnels': ['Bureautique', 'Langues', 'Management', 'Technique'],
    'Lycee': ['Général', 'Professionnel', 'Technique', 'International'],
    'Jardin Enfants': ['Crèche', 'Garderie', 'Préscolaire', 'Bilingue'],
    'Musique': ['Piano', 'Guitare', 'Chant', 'Batterie', 'Éveil'],
    'Guitare': ['Acoustique', 'Électrique', 'Classique', 'Cours'],
    
    # DIVERTISSEMENT
    'Concert': ['Live', 'Festival', 'Classique', 'Jazz'],
    'Festival': ['Musique', 'Cinéma', 'Théâtre', 'Art'],
    'Spectacle': ['Théâtre', 'Danse', 'Magie', 'Cirque'],
    'Boîte de nuit': ['Club', 'Lounge', 'VIP', 'Events'],
    'Club': ['Nuit', 'Sport', 'Privé', 'Loisirs'],
    'Billetterie': ['Concert', 'Spectacle', 'Sport', 'Festival'],
    'Jeux': ['Vidéo', 'Société', 'Casino', 'VR'],
    'Jouets': ['Enfants', 'Éducatifs', 'Jeux société', 'Peluches'],
    
    # ANIMAUX
    'Animalerie': ['Chiens', 'Chats', 'Poissons', 'Rongeurs', 'Accessoires'],
    'Animaux': ['Vente', 'Accessoires', 'Alimentation', 'Soins'],
    'Dog Sitter': ['Garde', 'Promenade', 'Pension', 'Domicile'],
    'Pension Animaux': ['Chiens', 'Chats', 'NAC', 'Luxe'],
    'Nac': ['Rongeurs', 'Reptiles', 'Oiseaux', 'Exotiques'],
    
    # MAISON & DÉCO
    'Meuble': ['Salon', 'Chambre', 'Bureau', 'Cuisine', 'Jardin'],
    'Meubles & Décoration': ['Design', 'Contemporain', 'Classique', 'Sur mesure'],
    'Luminaire': ['Suspension', 'Lampe', 'Applique', 'Design'],
    'Literie': ['Matelas', 'Sommier', 'Linge de lit', 'Oreillers'],
    'Lit': ['Double', 'Simple', 'Enfant', 'Design'],
    'Matelas': ['Mousse', 'Ressorts', 'Latex', 'Sur mesure'],
    'Canape': ['Droit', 'Angle', 'Convertible', 'Design'],
    'Armoire': ['Dressing', 'Penderie', 'Sur mesure', 'Rangement'],
    'Cuisine': ['Équipée', 'Sur mesure', 'Électroménager', 'Accessoires'],
    'Electromenager': ['Gros', 'Petit', 'Encastrable', 'Réparation'],
    'Tapis': ['Moderne', 'Oriental', 'Shaggy', 'Sur mesure'],
    'Rideau': ['Prêt-à-poser', 'Sur mesure', 'Store', 'Voilage'],
    'Vaisselle': ['Porcelaine', 'Design', 'Quotidien', 'Cadeaux'],
    'Linge Maison': ['Draps', 'Serviettes', 'Nappe', 'Déco'],
    
    # AUTRES SERVICES
    'Fleuriste': ['Bouquets', 'Compositions', 'Plantes', 'Fleurs de mariage', 'Deuil', 'Événements', 'Abonnement floral'],
    'Cadeaux': ['Original', 'Personnalisé', 'Luxe', 'Enfant'],
    'Cadeaux & Souvenirs': ['Local', 'Artisanat', 'Personnalisé', 'Suisse'],
    'Librairie': ['Romans', 'BD', 'Jeunesse', 'Beaux livres', 'Papeterie'],
    'Papeterie': ['Bureau', 'Créatif', 'Scolaire', 'Cadeaux'],
    'Fourniture Bureau': ['Consommables', 'Mobilier', 'Informatique', 'Papeterie'],
    'Photocopie': ['Impression', 'Reliure', 'Scan', 'Grand format'],
    'Copie & Impression': ['Documents', 'Plans', 'Affiches', 'Reliure'],
    'Imprimerie': ['Offset', 'Numérique', 'Grand format', 'Packaging'],
    'Photo & Impression': ['Tirage', 'Album', 'Cadre', 'Développement'],
    'Photographie': ['Portrait', 'Mariage', 'Événement', 'Corporate', 'Produit'],
    'Videaste': ['Mariage', 'Corporate', 'Clip', 'Drone'],
    'Publicite': ['Print', 'Digital', 'Affichage', 'Radio'],
    'Marketing': ['Digital', 'Contenu', 'Social media', 'Stratégie'],
    'Relations Publiques': ['Presse', 'Événement', 'Crise', 'Influence'],
    'Funeraire': ['Obsèques', 'Cercueil', 'Fleurs', 'Marbrerie'],
    'Pompes Funebres': ['Organisation', 'Transport', 'Cérémonie', 'Crémation'],
    
    # SECONDES MAINS
    'Seconde Main': ['Vêtements', 'Meubles', 'Électronique', 'Luxe'],
    'Seconde main': ['Vintage', 'Occasion', 'Dépôt-vente', 'Fripe'],
    'Occasion': ['Auto', 'Électronique', 'Meubles', 'Vêtements'],
    'Occasion & Vintage': ['Mode', 'Déco', 'Vinyle', 'Collector'],
    'Depot Vente': ['Mode', 'Luxe', 'Meubles', 'Puériculture'],
    'Brocante': ['Meubles', 'Objets', 'Art', 'Vintage'],
    
    # SHOPPING
    'shopping': ['Mode', 'Beauté', 'Maison', 'High-tech', 'Alimentation'],
    'Centre Commercial': ['Boutiques', 'Restauration', 'Loisirs', 'Services'],
    'Centre commercial': ['Mode', 'Alimentaire', 'Services', 'Restauration'],
    'Grand Magasin': ['Mode', 'Beauté', 'Maison', 'Gourmet'],
    'Grand magasin': ['Mode', 'Luxe', 'Maison', 'Food'],
    'Boutique': ['Mode', 'Concept', 'Créateurs', 'Local'],
    'Concept Store': ['Design', 'Mode', 'Lifestyle', 'Local'],
    
    # DIVERS
    'Autres': ['Services divers', 'Conseil', 'Assistance', 'Sur mesure'],
    'Services': ['À la personne', 'Aux entreprises', 'Techniques', 'Conseil'],
    'salon': ['Coiffure', 'Esthétique', 'Bien-être', 'Événements'],
    'expert_tech': ['Informatique', 'Électronique', 'Réparation', 'Conseil'],
}
...
async def purchase_training(training_id: str, current_user: dict = Depends(get_current_user)):
    ...
    try:
        ...
        checkout_request = CheckoutSessionRequest(
            ...
            currency="chf",
            success_url=f"{os.environ.get('FRONTEND_URL', 'https://resto-browse-1.preview.emergentagent.com')}/payment/success?session_id={{CHECKOUT_SESSION_ID}}&type=training&training_id={training_id}",
            cancel_url=f"{os.environ.get('FRONTEND_URL', 'https://resto-browse-1.preview.emergentagent.com')}/payment/cancel",
...
async def create_premium_checkout(plan: str, current_user: dict = Depends(get_current_user)):
    ...
    try:
        ...
        session_request = CheckoutSessionRequest(
            ...
            currency="chf",
            quantity=1,
            success_url=f"{os.environ.get('FRONTEND_URL', 'https://resto-browse-1.preview.emergentagent.com')}/dashboard/client?tab=premium&success=true&plan={plan}",
            cancel_url=f"{os.environ.get('FRONTEND_URL', 'https://resto-browse-1.preview.emergentagent.com')}/dashboard/client?tab=premium&cancelled=true",
            metadata={
                "plan": plan,
                "user_id": current_user['id'],
...
async def apply_for_certification(
    ...
    try:
        ...
        session_request = CheckoutSessionRequest(
            ...
            currency="chf",
            quantity=1,
            success_url=f"{os.environ.get('FRONTEND_URL', 'https://resto-browse-1.preview.emergentagent.com')}/enterprise-dashboard?tab=certifications&success=true",
            cancel_url=f"{os.environ.get('FRONTEND_URL', 'https://resto-browse-1.preview.emergentagent.com')}/enterprise-dashboard?tab=certifications&cancelled=true",
            metadata={
                "type": "certification",
...
async def book_expert_service(
    ...
    try:
        ...
        session_request = CheckoutSessionRequest(
            ...
            currency="chf",
            quantity=1,
            success_url=f"{os.environ.get('FRONTEND_URL', 'https://resto-browse-1.preview.emergentagent.com')}/dashboard?success=expert",
            cancel_url=f"{os.environ.get('FRONTEND_URL', 'https://resto-browse-1.preview.emergentagent.com')}/dashboard",
            metadata={
                "type": "expert_service",
