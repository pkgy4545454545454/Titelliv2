...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://homepage-theme-fix.preview.emergentagent.com')
...
class TestStripePaymentIntegration:
    ...
    def test_create_media_payment_session(self):
        ...
        payment_data = {
            "order_id": order_id,
            "origin_url": "https://homepage-theme-fix.preview.emergentagent.com"
        }
