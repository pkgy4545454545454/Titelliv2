...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://template-replica-2.preview.emergentagent.com')
...
class TestStripePaymentIntegration:
    ...
    def test_create_media_payment_session(self):
        ...
        payment_data = {
            "order_id": order_id,
            "origin_url": "https://template-replica-2.preview.emergentagent.com"
        }
